...
public class SOAPSAMLXACMLUnitTestCase extends AbstractXACMLIntegrationTests {
    ...
    private String endpoint = TestUtil.getTargetURL("/pdp/SOAPSAMLXACMLPDP");
    ...
    public ResourceType createResource(boolean permit) {
        ...
        if (permit) {
            AttributeType start = RequestAttributeFactory.createTimeAttributeType(
                    "urn:oasis:names:tc:xspa:1.0:resource:org:hoursofoperation:start", issuer, getXMLTime("00:00:00-08:00"));
            AttributeType end = RequestAttributeFactory.createTimeAttributeType(
                    "urn:oasis:names:tc:xspa:1.0:resource:org:hoursofoperation:end", issuer, getXMLTime("23:59:00-08:00"));
    ...
    private EnvironmentType createEnvironment(boolean permit) {
        ...
        if (permit) {
            ...
            AttributeType currentTime = RequestAttributeFactory.createTimeAttributeType(
                    "urn:oasis:names:tc:xacml:1.0:environment:current-time", issuer, getXMLTime("12:59:00-08:00"));
