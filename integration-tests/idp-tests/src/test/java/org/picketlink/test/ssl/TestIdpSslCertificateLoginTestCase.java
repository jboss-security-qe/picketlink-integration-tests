...
/**
 * Tests IdP authentication using a client certificate. Nothing more, nothing less.
 *
...
@RunAsClient
public class TestIdpSslCertificateLoginTestCase extends AbstractIdpSslCertificateLoginTestCase {
    ...
    public void testTrustedCertRoles(@ArquillianResource URI uri) throws Exception {
        ...
        testSuccessfulOutput(httpClient, address, "Unexpected roles.",  ",TheDuke,JBossAdmin,User,");
    }
